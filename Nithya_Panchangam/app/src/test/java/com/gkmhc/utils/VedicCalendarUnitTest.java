...
public class VedicCalendarUnitTest {
    ...
    public void testGetDinaVishesham() {
        checkAllDinaVisheshams();
    }

    public static void main(String args[]) {
        System.out.println("Hello World!");

        VedicCalendarUnitTest vcUT = new VedicCalendarUnitTest();
        vcUT.testGetDinaVishesham();
    }
    ...
    private void initVedicCalendar() {
        ...
        try {
            ...
            vedicCalendar = VedicCalendar.getInstance(assetsLocation,
                    ...
                    80.2707, 13.0827, "Asia/Kolkata",
                    VedicCalendar.AYANAMSA_CHITRAPAKSHA,
                    VedicCalendar.CHAANDRAMAANAM_TYPE_AMANTA, null);
            vedicCalendar.configureDinaVisheshamRules(assetsLocation + "/" +
                    DINA_VISHESHAM_RULES_FILE);
        } catch (Exception e) {
            e.printStackTrace();
            System.exit(-1);
        }
    ...
    public void checkDinaVisheshamSashti() {
        ...
        checkDinaVisheshamsforAnyMatch(10, 8, 2024,
                VedicCalendar.PANCHANGAM_DINA_VISHESHAM_SASHTI_VRATHAM);
        numTCs++;
        checkDinaVisheshamsforAnyMatch(9, 9, 2024,
                VedicCalendar.PANCHANGAM_DINA_VISHESHAM_SASHTI_VRATHAM);
        numTCs++;
        ...
        checkDinaVisheshamsforAnyMatch(3, 2, 2025,
                VedicCalendar.PANCHANGAM_DINA_VISHESHAM_SASHTI_VRATHAM);
        numTCs++;
        checkDinaVisheshamsforAnyMatch(4, 3, 2025,
                VedicCalendar.PANCHANGAM_DINA_VISHESHAM_SASHTI_VRATHAM);
        numTCs++;
        ...
        checkDinaVisheshamsforAnyMatch(21, 5, 2026,
                VedicCalendar.PANCHANGAM_DINA_VISHESHAM_SASHTI_VRATHAM);
        numTCs++;
        checkDinaVisheshamsforAnyMatch(19, 6, 2026,
                VedicCalendar.PANCHANGAM_DINA_VISHESHAM_SASHTI_VRATHAM);
        numTCs++;
    ...
    public void checkDinaVisheshamEkadashi() {
        ...
        checkDinaVisheshamsforAnyMatch(8, 8, 2022,
                VedicCalendar.PANCHANGAM_DINA_VISHESHAM_EKADASHI);
        numTCs++;
        checkDinaVisheshamsforAnyMatch(23, 8, 2022,
                VedicCalendar.PANCHANGAM_DINA_VISHESHAM_EKADASHI);
        numTCs++;
        // TODO - Not Working!
        ...
        numTCs++;
        // TODO - Not Working!
        //checkDinaVisheshamsforAnyMatch(3, 12, 2022,
        //        VedicCalendar.PANCHANGAM_DINA_VISHESHAM_EKADASHI);
        numTCs++;
        ...
        checkDinaVisheshamsforAnyMatch(3, 3, 2023,
                VedicCalendar.PANCHANGAM_DINA_VISHESHAM_EKADASHI);
        numTCs++;
        checkDinaVisheshamsforAnyMatch(18, 3, 2023,
                VedicCalendar.PANCHANGAM_DINA_VISHESHAM_EKADASHI);
        numTCs++;
        ...
        checkDinaVisheshamsforAnyMatch(23, 11, 2023,
                VedicCalendar.PANCHANGAM_DINA_VISHESHAM_EKADASHI);
        numTCs++;
        checkDinaVisheshamsforAnyMatch(9, 12, 2023,
                VedicCalendar.PANCHANGAM_DINA_VISHESHAM_EKADASHI);
        numTCs++;
        // TODO - Not Working!
        ...
        checkDinaVisheshamsforAnyMatch(2, 6, 2024,
                VedicCalendar.PANCHANGAM_DINA_VISHESHAM_EKADASHI);
        numTCs++;
        checkDinaVisheshamsforAnyMatch(18, 6, 2024,
                VedicCalendar.PANCHANGAM_DINA_VISHESHAM_EKADASHI);
        numTCs++;
    ...
    public void checkDinaVisheshamPradosham() {
        ...
        numTCs++;
        // TODO - Not Working!
        //checkDinaVisheshamsforAnyMatch(30, 1, 2022,
        //        VedicCalendar.PANCHANGAM_DINA_VISHESHAM_PRADOSHAM);
        numTCs++;
        // TODO - Not Working!
        //checkDinaVisheshamsforAnyMatch(14, 2, 2022,
        //        VedicCalendar.PANCHANGAM_DINA_VISHESHAM_PRADOSHAM);
        numTCs++;
        ...
        numTCs++;
        // TODO - Not Working!
        //checkDinaVisheshamsforAnyMatch(19, 7, 2024,
        //        VedicCalendar.PANCHANGAM_DINA_VISHESHAM_PRADOSHAM);
        numTCs++;
        ...
        numTCs++;
        // TODO - Not Working!
        //checkDinaVisheshamsforAnyMatch(1, 3, 2026,
        //        VedicCalendar.PANCHANGAM_DINA_VISHESHAM_PRADOSHAM);
        numTCs++;
    ...
    public void checkDinaVisheshamsforAnyMatch(int date, int month, int year,
        ...
        try {
            ...
            System.out.print("Checking Dhina Vishesham for (" +
                    ...
                    "Dina Vishesham" +
                    ") on " + date + "/" + month + "/" + year + "...");
            if (dinaVisheshamActualList.contains(dinaVisheshamExpected)) {
